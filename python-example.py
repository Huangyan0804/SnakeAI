...
def new_food():#随机函数生成新的食物
    ...
    pygame.draw.rect(playSurface,redColour,Rect(18*int(food/WIDTH), 18*(food%WIDTH),18,18))
...
def make_move(pbest_move):
    ...
    for body in snake:#画蛇，身体，头，尾
    	pygame.draw.rect(playSurface,whiteColour,Rect(18*int(body/WIDTH), 18*(body%WIDTH),18,18))
    pygame.draw.rect(playSurface,greenColour,Rect(18*int((snake[snake_size-1]/WIDTH)),18*(snake[snake_size-1]%WIDTH),18,18))
    pygame.draw.rect(playSurface,headColour,Rect(18*int(p/WIDTH), 18*(p%WIDTH),18,18))
    ...
    if snake[HEAD] == food:
        ...
        pygame.draw.rect(playSurface,blackColour,Rect(18*int((snake[snake_size]/WIDTH)),18*(snake[snake_size]%WIDTH),18,18))
        # 刷新pygame显示层
        pygame.display.flip() 
...
# 创建pygame显示层
playSurface = pygame.display.set_mode((300,300))
